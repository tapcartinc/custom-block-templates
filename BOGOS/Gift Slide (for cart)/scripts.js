...
const BogosIntegration = {
  ...
  renderBogosGiftSliderView: (bogosGiftSlider) => {
    ...
    document.querySelector(".freegifts-main-container .fg-section-title").style.color = customizeColor?.gift_slider_title_color

    const productsTitle = document.querySelectorAll(".freegifts-main-container .product-title")
    productsTitle.forEach((productTitle) => {
      productTitle.style.color = customizeColor?.product_title_color
    })

    const productsOriginalPrice = document.querySelectorAll(".freegifts-main-container .original-price")
    productsOriginalPrice.forEach((productOriginalPrice) => {
      productOriginalPrice.style.color = customizeColor?.original_price_color
    })

    const productsGiftPrice = document.querySelectorAll(".freegifts-main-container .gift-price")
    productsGiftPrice.forEach((productGiftPrice) => {
      productGiftPrice.style.color = customizeColor?.discounted_price_color
    })

    const buttonsAddToCart = document.querySelectorAll(".freegifts-main-container .btn-add-to-cart")
    buttonsAddToCart.forEach((buttonAddToCart) => {
      buttonAddToCart.style.color = customizeColor?.add_to_cart_color
      buttonAddToCart.style.backgroundColor = customizeColor?.add_to_cart_btn_color
    })
  },
  getBogosGiftsInCart: () => {
